...
import createAdminNotificationsPanelStyles from '../../style/admin/adminNotificationsPanel.styles';
...
export default function AdminNotificationsPanel({
  ...
  const styles = useMemo(() => createAdminNotificationsPanelStyles(theme), [theme]);
