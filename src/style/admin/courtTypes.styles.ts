...
export const tiposPistaStyles = StyleSheet.create({
  ...
  colName: { flex: 1.2, minWidth: 0, flexShrink: 1 },
  colImage: { flex: 1.2, minWidth: 92, justifyContent: 'center', alignItems: 'center' },
  colCount: { flex: 0.8, minWidth: 60, justifyContent: 'center', alignItems: 'center' },
  colActions: { flex: 0.8, minWidth: 74, justifyContent: 'flex-end', alignItems: 'center' },
});
