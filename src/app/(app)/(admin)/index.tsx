...
export default function AdminManagementScreen() {
  ...
  const adminOptions = [
    ...
    },
    {
      ...
      icon: 'account-group',
      route: '/(admin)/(management)/usuarios',
      color: '#2196F3',
    ...
    },
    {
      ...
      route: '/(admin)/(management)/membresias',
      color: '#9C27B0',
    ...
    },
    {
      ...
      subtitle: 'Crea avisos globales y revisa el historial enviado.',
      icon: 'bell-badge',
      route: '/(admin)/(management)/notificaciones',
      color: '#7C4DFF',
      cta: 'Gestionar notificaciones',
    },
  ];
